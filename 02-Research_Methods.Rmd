...
-   I am the *oldest* of my siblings in terms of **birth order**.
...
-   When asked if I am **vegetarian**, I might have said *yes*, or *no*, or *kind of* (maybe pescatarian?), or *sometimes*.

-   When asked about **birth order** in my family, I might have been *first-born (oldest)*, or *second-born*, or *third-born*, or *middle child*, or *youngest* (or maybe only child). As you can see, saying that I'm the oldest tells you about the relationship between me and my siblings, but it doesn't give you specifics. Am I a year older than my sister? Two years? Ten years? (Three years is the answer.)

-   My **gender** is likely to be *male* or *female*, or I may identify with *neither*, or I may explicitly call myself *transgender*, or I may have another gender identity.

As you can see, for some things (like age) it seems fairly obvious what the set of possible measurements should be, whereas for other things it gets a bit tricky. But I want to point out that even in the case of someone’s age, it’s much more subtle than this. For instance, in the example above, I assumed that it was okay to measure age in years. But if you’re a developmental psychologist, that’s way too crude, and so you often measure age in *years and months* (if a child is 2 years and 11 months, this is often written as “2;11”). If you’re interested in newborns, you might want to measure age in *days since birth*, maybe even *hours since birth*. In other words, the way in which you specify the allowable measurement values is important.
...
:::point
The scale of our data limits the kinds of analyses we can perform. We can't find the average of nominal groups, for example. We can't *really* compare ordinal groups the same we can compared *interval* and *ratio* groups.
:::
...
:::point
We will use **independent variables** (aka predictors, aka manipulated variables) to look for differences or relationships in **dependent variables** (aka outcomes, aka measured variables). Don't let the names distract you, because different statistical procedures will "call" these variables slightly different names. The structure is almost always the same! 
:::
