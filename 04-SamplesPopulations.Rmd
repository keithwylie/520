...
:::source
This chapter is adapted from text by Danielle Navarro and Matthew Crump.
:::
...
What is "probability"? It might seem surprising to you, but while statisticians and mathematicians (mostly) agree on what the **rules** of probability are, there's much less of a consensus on what the word really **means**. It seems weird because we're all very comfortable using words like "chance," "likely," "possible," and "probable," and it doesn't seem like it should be a very difficult question to answer. If you had to explain "probability" to a five year old, you could do a pretty good job. But if you've ever had that experience in real life, you might walk away from the conversation feeling like you didn't quite get it right, and that (like many everyday concepts) it turns out that you don't **really** know what it's all about.

So I'll have a go at it. Let's suppose I want to bet on a soccer game between two teams of robots, **Kansas City Clinks** and **Wichita Wires**. After thinking about it, I decide that there is an 80% probability that **Kansas City Clinks** will win. What do I mean by that? Here are three possibilities...

-   They're robot teams, so I can make them play over and over again, and if I did that, **Kansas City Clinks** would win 8 out of every 10 games on average.

-   For any given game, I would only agree that betting on this game is only "fair" if a \$1 bet on **Wichita Wires** gives a \$5 payoff (i.e. I get my \$1 back plus a \$4 reward for being correct), as would a \$4 bet on **Kansas City Clinks** (i.e., my \$4 bet plus a \$1 reward).

-   My subjective "belief" or "confidence" in a **Kansas City Clinks** victory is four times as strong as my belief in a **Wichita Wires** victory.
